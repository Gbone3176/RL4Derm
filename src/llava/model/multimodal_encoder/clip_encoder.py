...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, load_weights=True):
        ...
        local_files_only = os.path.exists(self.vision_tower_name)
        ...
        if 'clip' in self.vision_tower_name.lower():
            if load_weights:
                ...
                self.vision_tower = CLIPVisionModel(self.config)
            ...
            if load_weights:
                ...
                self.vision_tower = AutoModel.from_config(self.config, trust_remote_code=True)
        else:
